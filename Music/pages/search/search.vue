				...
				<block v-if="searchType ==1">
					...
					<view class="search-history">
						...
						<view class="search-history-list">
							<view v-for="(item, index) in serachHistory" :key='index' @tap="handleToWord(item)">{{item}}</view>
						</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			handleToSearch(word){
				...
				// ES6提供的去重的方法
				this.serachHistory = [...new Set(this.serachHistory)]
